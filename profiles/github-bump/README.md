...
[`git-cliff`](../git-cliff/README.md) lists under Pins. It goes as far as
`bump.mode` in `.github/automation.json`, which
[`automation`](../automation/README.md) sets:
...
[`github-watch`](../github-watch/README.md) opens an issue for it. The jobs that
