...
| `.just/yamllint.just`                      | whole | owned  |       |
| `.config/mise/conf.d/devset-yamllint.toml` | whole | owned  |       |
| `.config/mise/mise.lock`                   | keys  | owned  |       |

## Recipes

- `check-yamllint`: Checks every YAML file the repository owns, tracked or new,
