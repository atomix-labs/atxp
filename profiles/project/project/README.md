...
- The README's badges follow the profiles applied: CI where
  ...
  crate [`cargo-workspace`](../../cargo/cargo-workspace/README.md) names, and
  the book where [`mdbook`](../../docs/mdbook/README.md) builds one. A README
  the project starts from here holds the block under its title; one it has
  already gets the block at its end, which the project may move.
