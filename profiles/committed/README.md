...
the commit changes, a profile or a crate. [`git-cliff`](../git-cliff/README.md)
...
| `.just/committed.just`                      | whole | owned  |       |
| `.config/mise/conf.d/devset-committed.toml` | whole | owned  |       |
| `.config/mise/mise.lock`                    | keys  | owned  |       |

## Recipes

- `check-committed`: Checks every commit the branch adds to the default branch:
