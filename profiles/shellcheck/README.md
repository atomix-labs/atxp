...
else's and is left out. [`actionlint`](../actionlint/README.md) runs it on
...
| -------------------------------------------- | ----- | ------ | ----- |
| `.just/shellcheck.just`                      | whole | owned  |       |
| `.config/mise/conf.d/devset-shellcheck.toml` | whole | owned  |       |
| `.config/mise/mise.lock`                     | keys  | owned  |       |

## Recipes

- `check-shellcheck`: Lints every shell script the repository owns, following
