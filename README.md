...
| [`github-release`](profiles/github/github-release/README.md)             | A release from its tag: every package-* recipe on each platform, then the GitHub Release with git-cliff's notes                                 | `RELEASE.md`, `.github/workflows/release.yml`                                                                                                               |
...
| `repository`    | none                | The GitHub repository, owner/name                               | [`cargo-workspace`](profiles/cargo/cargo-workspace/README.md), [`git-changelog`](profiles/git/git-changelog/README.md), [`github-release`](profiles/github/github-release/README.md)                                                      |
