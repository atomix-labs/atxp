...
| `repository`             | none                | The GitHub repository, owner/name                                      | [`cargo-workspace`](profiles/cargo/cargo-workspace/README.md), [`git-changelog`](profiles/git/git-changelog/README.md), [`github-release`](profiles/github/github-release/README.md), [`project`](profiles/project/project/README.md)     |
