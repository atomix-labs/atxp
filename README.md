...
| [`cargo-workspace`](profiles/cargo/cargo-workspace/README.md) | A Cargo workspace's own settings: its build output ignored, and requirements resolved within rust-version              | `.gitignore` (block), `.cargo/config.toml` (keys)                                                                                                  |
...
| `repository`    | none    | The GitHub repository the changelog links into, owner/name      | [`git-changelog`](profiles/git/git-changelog/README.md)                                                                                                                                                                                   |
